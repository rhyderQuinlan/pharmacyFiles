...
$sql = "Insert into Supplier (SupplierID, SupplierName, SupplierLocation, Email, Website, TelNum, deleteFlag)
  VALUES ('$supplier_id', '$supplier_name','$supplier_address','$supplier_email','$supplier_website','$supplier_tel', '$deleteFlag')";
