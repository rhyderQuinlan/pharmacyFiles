  ...
  function table($con,$sql)
	{
		...
		echo '<table id="drugTable">
		<tr><th>DrugID</th><th>Brand Name</th><th>Generic Name</th><th>Form</th><th>Strength</th><th>Strength</th><th>Qty in Stock</th><th>Reorder Level</th><th>Reorder Qty</th><th>Suppliers Name</th></tr>';
      ...
      $drugID = $row['dID'];
			echo "
              <tr>
                <td>".$row['dID']."</td>
                <td><a href='reorder.php?mydata=$drugID' >".$row['dBrandName']."</a></td>
